    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'center', width: '70%', textAlign: 'center', alignItems: 'center' }} >
            <Stack>
                ...
                <SkillSection title="Languages" chipList={languages} />
                <SkillSection title="Frameworks" chipList={frameworks} />
                <SkillSection title="Other Tools" chipList={other} />
            </Stack>
        </Box>
    );
}

function SkillSection({title, chipList}: {title: string, chipList: skillsChip[]}) {
    return (
        <>
